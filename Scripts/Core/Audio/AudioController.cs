...
namespace UnityCore {
  namespace Audio {
    public class AudioController : MonoBehaviour {
      ...
      private Hashtable m_AudioTable; // relation between audioTypes (key) and audioTracks (value)
      private Hashtable m_JobTable; // relation between audioTypes (key) and Jobs (value) (Coroutine, IEnumerator)
      ...
      #region Private Functions
        ...
        private void RemoveJob(AudioType _type) {
          if (!m_JobTable.ContainsKey(_type)) {
            LogWarning($"Trying to remove job [{_type}] that is not running");
            return;
          }
